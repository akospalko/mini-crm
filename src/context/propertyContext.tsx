...
import {DATABASE_RESOURCES, REDUCER_ACTION_TYPE_PROPERTY} from "../types/actionTypes";
...
const reducer = (state: PropertyStateI, action: PropertyContextReducerActionI): PropertyStateI => {
  // Errors
  const errorActionPayloadMissing = (textMessage: REDUCER_ACTION_TYPE_PROPERTY): Error => new Error(`${"error-action-payload-missing"} ${textMessage}`);
