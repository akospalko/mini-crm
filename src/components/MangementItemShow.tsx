// TODO: Create / update logic for client items
...
import { deleteClient, deleteProperty } from "../Requests/apiRequests";
  ...
  return (
    ...
    >
      ...
      <ManagementItemButton
        ...
        clicked={activeDeleteItemHandler}
      >
