...
const CreateItemButton = ({ title, changed }: CreateItemButtonPropsI) => {
  ...
  return (
    <button
      ...
      title={title}
      className="h-[50px] w-[125px] select-none rounded bg-color_accent
      px-[0.5rem] hover:bg-color_accent_secondary focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color_accent"
      onClick={changed}
    >
